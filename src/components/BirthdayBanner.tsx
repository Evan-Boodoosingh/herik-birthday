        ...
        >
          ...
          <div className="flex justify-center items-center gap-8 mb-6">
            ...
            <motion.div
              ...
              transition={{ duration: 2, repeat: Infinity }}
            >
              <Cake className="w-16 h-16 text-orange-500" />
            </motion.div>
            <motion.div
              animate={{ rotate: [0, -10, 10, 0] }}
              transition={{ duration: 2, repeat: Infinity }}
            >
              <PartyPopper className="w-12 h-12 text-red-400" />
            </motion.div>
          </div>
          ...
          >
            <h2 className="text-5xl md:text-7xl font-light tracking-wide mb-4">
              <span className="text-transparent bg-clip-text bg-linear-to-r from-orange-400 via-red-500 to-amber-500" style={{
            ...
            >
              <div className="text-center">
                <div className="text-4xl font-light text-orange-500 mb-2">40</div>
                <div className="text-sm text-[#f4e8d0]/70 tracking-wider uppercase">Years of Adventure</div>
              </div>
              <div className="text-center border-x border-orange-500/20">
                <div className="text-4xl font-light text-orange-500 mb-2">∞</div>
                <div className="text-sm text-[#f4e8d0]/70 tracking-wider uppercase">Memories Made</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-light text-orange-500 mb-2">1</div>
                <div className="text-sm text-[#f4e8d0]/70 tracking-wider uppercase">Pirate King</div>
              </div>
            </motion.div>
            ...
            >
              <p className="text-lg text-[#f4e8d0]/80 italic max-w-2xl mx-auto">
                ...
                When they are ravaged by an incurable disease? No. When they drink a soup made from a poisonous mushroom? No! 
          ...
          {Array.from({ length: 20 }).map((_, i) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundColor: ['#ff6f00', '#d32f2f', '#fbbf24', '#ef4444', '#f59e0b'][
                    i % 5
                  ],
                }}
              />
