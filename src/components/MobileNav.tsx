    ...
    <div className="md:hidden">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-50">
          ...
          />
          <div className="absolute top-6 left-1/2 transform -translate-x-1/2 w-11/12 max-w-md bg-gradient-to-br from-[#2d1810] via-[#3d2010] to-[#2d1810] backdrop-blur-xl rounded-2xl border-2 border-orange-500/40 shadow-[0_0_50px_rgba(255,111,0,0.4)] p-6">
